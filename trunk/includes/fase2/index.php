...
if (isset($_GET['Start'])) {
                                    ...
                                    <td>
                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                                            ...
                                            if ($poll['Status'] == get_poll_status_id('Ingestuurd')) {
                                                ?>
                                                <input type="submit"
                                                       value="<?php echo get_text('Poll_already_answered'); ?>"/>
                                            <?php
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                <input type="submit" name="answer_poll"
                                                       value="<?php echo get_text('Answer_poll'); ?>"/>
                                            <?php
                                            }
                                            ?>
                                        </form>
                                    ...
                                    <td>
                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                <input type="submit" name="edit_comment"
                                                       value="<?php echo get_text('Edit_comment'); ?>"/>
                                                <input type="submit" name="delete_comment"
                                                       value="<?php echo get_text('Delete_comment'); ?>"/>
                                            <?php
                                            }
                                            ?>
                                        </form>
        ...
        <?php
            ...
            if (isset($_POST['answer_questions']) || isset($_POST['save_questions']) || isset($_POST['add_comment'])) {
                ...
                <div class="topContent">
                    ...
                    <h3 class="back"><a
                            href="<?php echo $_SERVER['PHP_SELF']; ?>?Start=start&amp;Poll=<?php echo $poll; ?>"><?php echo get_text('Back'); ?></a>
                    </h3>

                    <h3 class="next"><a
                            href="<?php echo $_SERVER['PHP_SELF']; ?>?Start=start"><?php echo get_text('Next'); ?></a>
                    </h3>
                </div>
            ...
            <?php
                ...
                <div class="topContent">
                    ...
                    if ($_SESSION['user_id'] == $reviewer_id) { ?>
                        ...
                        <form method="post"
                              action="<?php echo $_SERVER['PHP_SELF']; ?>?Start=start&amp;Poll=<?php echo $poll; ?>">
                            <?php
                                                    ...
                                                    for ($value = 1; $value < 7; $value++) {
                                                        ...
                                                        <td style="text-align:center;">
                                                            <input type="radio" name="<?php echo $question['ID']; ?>"
                                                                   value="<?php echo $value; ?>" <?php if ($value == get_answer_value_by_name('Neutraal')) {
                                                                echo 'checked';
                                                            } ?>/>
                                                        </td>
                                                    <?php
                        ...
                        <textarea class="comment" <?php if ($poll_status == get_poll_status_id('Ingestuurd')) {
                            echo "disabled";
                        } ?> id="comment" name="comment"><?php if (get_comment($poll)) {
                            ...
                            if ($poll_status == get_poll_status_id('Ingestuurd')) {
                                ?>
                                <h3>
                                    <a href="<?php $_SERVER['PHP_SELF']; ?>?Start&amp;Step=2"><?php echo get_text('Next'); ?></a>
                                </h3>
                            <?php
    ...
    <div class="topContent">
        ...
        <span id="start"><a href="?Start"><h1><?php echo get_text('View') . ' ' . strtolower(get_text('Polls')); ?>
                    >></h1></a></span>
    </div>
<?php
}
