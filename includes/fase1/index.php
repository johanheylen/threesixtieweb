		...
		if(!isset($_GET['Step'])){
			...
			if(isset($_POST['answer_own_questions']) || isset($_POST['save_own_questions'])){
				...
				<div class="topContent">
					...
					<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>?Start&Step=1"><?php echo get_text('Back'); ?></a></h3>
					<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>?Start&Step=2"><?php echo get_text('Next'); ?></a></h3>
				</div>
				...
				if(isset($_POST['preferred_reviewer'])){
					...
					?>
					<div class="topContent">
						<?php echo get_text('Click_next_for_next_step'); ?>
						<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>?Start&Step=2"><?php echo get_text('Back'); ?></a></h3>
						<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>?Start&Step=3"><?php echo get_text('Next'); ?></a></h3>
					</div>
					<?php
				}else{
				...
				?>
					<div class="topContent">
						<?php echo get_text('End_phase1_text'); ?>
						<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>?Start&Step=3"><?php echo get_text('Back'); ?></a></h3>
						<h3><a href="<?php echo $_SERVER['PHP_SELF']; ?>"><?php echo get_text('Exit'); ?></a></h3>
					</div>
					<?php
				}
			}else if($_GET['Step'] == 1){
